...
// Configured once, at module scope, so it is in place before any store or hook
// reads it. The core has no bundler of its own and cannot read NEXT_PUBLIC_*
// on its own behalf in every skin.
